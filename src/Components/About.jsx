    ...
    <section className="flex flex-col justify-between items-center p-8 bg-gray-900  shadow-lg border border-gray-700">
      <div className="flex flex-col items-center -mt-1">
        ...
        <p className="mb-5 text-md text-gray-300 text-center max-w-4xl leading-relaxed">
          Welcome to our React-powered blog! Here, you'll find posts about
          coding, daily thoughts, and the occasional pizza debate. Built with
          <a
            className="font-semibold cursor-pointer text-amber-300 ml-0.5"
          ...
          , this project is a playground for learning and sharing.
        </p>
        ...
        <div className="text-gray-300 text-center max-w-2xl leading-relaxed">
          <p className="mb-3">
            Whether you're here to read, write, or just explore, we hope you
            enjoy the experience. This blog is designed to be simple, fast, and
            fun to use.
          </p>
          <p>
